...
export default function OutletsPage() {
    return (
        <main className="min-h-screen bg-slate-50">
            {/* Hero */}
            <section className="relative w-full bg-[#050505] pt-36 pb-24 px-6 overflow-hidden">
                {/* Background decorations */}
                <div className="absolute inset-0 pointer-events-none">
                    <div className="absolute top-0 left-1/4 w-[500px] h-[500px] bg-primary/20 blur-[120px] rounded-full -translate-y-1/3" />
                    <div className="absolute bottom-0 right-1/4 w-[400px] h-[400px] bg-blue-600/15 blur-[100px] rounded-full translate-y-1/2" />
                </div>
                ...
                <div className="relative max-w-5xl mx-auto text-center z-10">
                    ...
                    <p className="text-lg md:text-xl text-white/60 font-open-sans max-w-2xl mx-auto leading-relaxed">
