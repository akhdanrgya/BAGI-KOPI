...
import { Briefcase, MapPin, ChevronRight, Send, ChevronDown, X } from "lucide-react";
...
const CAREER_OPPORTUNITIES: Job[] = [
    {
        ...
        description: "Join our vibrant team as a Barista. We are looking for passionate individuals who love coffee and enjoy providing excellent customer service. You will be responsible for crafting signature beverages and ensuring every customer leaves with a smile.",
        requirements: [
    ...
    },
    {
        ...
        description: "We are seeking a proactive and leadership-driven Store Manager. You will oversee daily operations, manage staff, ensure high-quality product standards, and drive sales targets to make our coffee shop successful.",
        requirements: [
    ...
    },
    {
        ...
        description: "Are you creative and always up-to-date with social media trends? We need a Social Media Specialist to handle our community engagement, create viral content, and grow the Bagi Kopi digital presence.",
        requirements: [
...
${formData.name}
        ...
        window.location.href = `mailto:hrd@bagikopi.id?subject=${subject}&body=${body}`;
        ...
        <main className="min-h-screen bg-white">
                ...
                <div className="max-w-7xl mx-auto relative z-10">
                    ...
                    >
                        ...
                        <p className="text-lg md:text-xl text-white/90 font-open-sans max-w-2xl leading-relaxed">
                            We are always looking for passionate, creative and driven individuals to join our growing family. Bring your unique skills to the table and let's craft something amazing together.
                        </p>
                    </motion.div>
                </div>
            ...
            <section className="py-24 bg-white relative">
                <div className="max-w-7xl mx-auto px-6">
                    <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
                        <div>
                            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 font-dm-sans mb-4">Open Positions</h2>
                            <p className="text-slate-600 font-open-sans text-lg">Find a role that fits your passion and expertise.</p>
                        </div>
                    </div>
                        ...
                        {CAREER_OPPORTUNITIES.map((job, index) => {
                            ...
                            return (
                                <motion.div
                                    ...
                                    className={`group bg-white rounded-2xl border ${isExpanded ? 'border-primary shadow-lg shadow-primary/10' : 'border-slate-200 hover:shadow-lg hover:shadow-slate-200/50 hover:border-primary/30'
                                        ...
                                        {isExpanded && (
                                            ...
                                            >
                                                <div className="pt-8 mt-6 border-t border-slate-100">
                                                    <div className="mb-6">
                                                        <h4 className="font-semibold text-slate-900 font-open-sans text-sm tracking-wide uppercase mb-3 text-primary">Job Description</h4>
                                                    ...
                                                    <div>
                                                        <h4 className="font-semibold text-slate-900 font-open-sans text-sm tracking-wide uppercase mb-3 text-primary">Requirements</h4>
            ...
            <section className="py-24 bg-slate-900 relative overflow-hidden">
                ...
                <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
                    <h2 className="text-3xl md:text-5xl font-bold text-white mb-6 font-dm-sans">Don't see a role that fits?</h2>
                    <p className="text-white/70 font-open-sans text-lg mb-10 max-w-2xl mx-auto">
                        We are continuously growing. Send us your open application and let us know how you can contribute to our journey.
                    </p>
                    <a
                    ...
                    <div className="fixed inset-0 z-[110] flex items-center justify-center px-4 pt-20 md:pt-0">
                        ...
                        >
                            ...
                            <div className="mb-8 pr-8">
                                <h3 className="text-2xl font-bold text-slate-900 font-dm-sans mb-1">Apply for {selectedJob.title}</h3>
                                <p className="text-slate-500 text-sm font-open-sans">Fill out the details below to generate your email application.</p>
                            </div>

                            <form onSubmit={submitApplication} className="space-y-5">
                                <div>
                                    <label htmlFor="name" className="block text-sm font-semibold text-slate-900 font-open-sans mb-2">Full Name</label>
                                    <input
                                        type="text"
                                        id="name"
                                        name="name"
                                ...
                                <div>
                                    <label htmlFor="email" className="block text-sm font-semibold text-slate-900 font-open-sans mb-2">Email Address</label>
                                    <input
                                        type="email"
                                        id="email"
                                        name="email"
                                ...
                                <div>
                                    <label htmlFor="phone" className="block text-sm font-semibold text-slate-900 font-open-sans mb-2">Phone Number</label>
                                    <input
                                        type="tel"
                                        id="phone"
                                        name="phone"
                                ...
                                <div>
                                    <label htmlFor="whyBagiKopi" className="block text-sm font-semibold text-slate-900 font-open-sans mb-2">Mengapa Anda tertarik bekerja di Bagi Kopi?</label>
                                    <textarea
                                        id="whyBagiKopi"
                                        name="whyBagiKopi"
                                        required
                                ...
                                <div>
                                    <label htmlFor="cvFile" className="block text-sm font-semibold text-slate-900 font-open-sans mb-2">Upload CV (PDF Only)</label>
                                    ...
                                    <p className="mt-2 text-xs text-slate-500 font-open-sans text-amber-600">Note: Browser your CV here. You may still need to manually attach this file in your email app before sending.</p>
                                </div>
