                ...
                <div className="space-y-12">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {valuesData.values.items.map((item, index) => (
                            <div key={index} className="bg-zinc-800 border border-zinc-700 p-8 rounded-2xl flex flex-col items-center text-center hover:bg-zinc-800/80 transition-colors shadow-sm">
