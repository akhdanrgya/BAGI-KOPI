        ...
        <section id="partnership" className="w-full bg-primary py-24 px-6 md:px-12 text-white overflow-hidden relative">
            ...
            <div className="max-w-5xl mx-auto relative z-10 text-center">
                ...
                <div className="flex flex-col sm:flex-row justify-center gap-6">
                    <Link href="#" className="px-8 py-4 bg-white text-primary font-bold font-open-sans tracking-widest uppercase rounded-full shadow-xl hover:scale-105 transition-transform">
                        Info Partnership
                    </Link>
                    <Link href="#" className="px-8 py-4 bg-transparent border-2 border-white/30 text-white font-bold font-open-sans tracking-widest uppercase rounded-full hover:bg-white/10 transition-colors">
                        Info Reservasi
                    </Link>
                </div>
            </div>
