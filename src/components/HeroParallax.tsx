...
export function HeroParallax() {
  ...
  return (
    <main ref={containerRef} className="relative w-full h-[300vh]">
      ...
      <div className="sticky top-0 h-screen w-full overflow-hidden bg-[#0076F8] flex items-center justify-center">
        
        {/* Kontainer Teks (Sisi Kiri) */}
        <motion.div 
          className="absolute left-0 w-full md:w-1/2 h-full flex flex-col justify-center px-6 md:px-16 lg:px-24 z-10 pointer-events-none"
          style={{ 
            opacity: textOpacity, 
            y: textY, 
        ...
        {/* Kontainer Gambar Gelas (Bergeser ke Kanan) */}
        <motion.div 
